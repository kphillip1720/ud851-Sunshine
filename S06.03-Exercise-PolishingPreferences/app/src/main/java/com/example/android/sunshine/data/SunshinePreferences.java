...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return sharedPreferences.getString(prefLocationKey, prefLocationDefault);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        String prefUnitsDefault = context.getString(R.string.pref_units_metric);
        String preferredUnits = sharedPreferences.getString(prefUnitsKey, prefUnitsDefault);
